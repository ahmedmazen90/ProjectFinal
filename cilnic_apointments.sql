...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2023 at 06:54 PM
...
(4, '2023-06-14', 'saturday', '10-12', 'free'),
(5, '2023-06-23', 'sunday', '10-12', 'free');
...
(1, 'ahmed', 'aa', 'ahmed', 'h', 20, 'ahmed@gmail.com', '5966', 'male', 'admin'),
(2, 'ahmed2', '12', 'ahmed2', 'a', 20, 'a@gmail.com', '5656', 'male', 'patient');
...
ALTER TABLE `booked_appointments`
  ...
  ADD CONSTRAINT `test2` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`id`);
COMMIT;
